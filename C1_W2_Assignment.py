...
def train_naive_bayes(freqs, train_x, train_y):
    ...
    # looping for each word in every pair at pair[0] in entire corpus, where freqs is a dictionary where the key is a pair of word and sentiment unlocking frequency
    ...
    # Since positive sentiment is represented as 1, np.sum sums up every ones in the train_y set and effectively skips the negative 0s
    ...
    for word in vocab:
        ...
        # the 0 is the default for get function if word is not found
...
my_tweet = 'I am happy because I am so over the glad :)'
